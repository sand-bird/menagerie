...
# we execute this on our own `animation_finished` signal,
# which passes the finished animation's id. no choice but to
# accept the argument, even though we don't need it.
